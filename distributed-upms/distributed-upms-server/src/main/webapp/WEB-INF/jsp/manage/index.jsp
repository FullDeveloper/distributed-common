...
<head>
    ...
    <link href="${basePath}/resources/distributed-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/distributed-admin/css/admin.css" rel="stylesheet"/>
</head>
<body>
<style>
    /** skins **/
    ...
    <ul id="menu">
        ...
        <li id="logo" class="hidden-xs">
            <a href="${basePath}/manage/index">
                <img src="${basePath}/resources/distributed-admin/images/logo.png"/>
            </a>
...
<script src="${basePath}/resources/distributed-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/distributed-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/distributed-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/distributed-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/distributed-admin/js/admin.js"></script>
<script src="${basePath}/resources/distributed-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/distributed-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>
